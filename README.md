This is the original source code/Unity project of the game with everything included. The recommended version for this is Unity 2019.4.41f2, but you should be able to safely port it to newer versions.
...
Also some of the code was early GPT garbage because I still haven't forced myself to learn coding.
